##############################################################
# =======================================================
# Lab 17 continued: Simulating Trees
# ======================================================
# This lab is based off of the first section of the Lineage diversification in R tutorial from Brian Moore, Tracy Heath, Bob Thomson, & Rich Glor and is available from the Treethinkers.org website
...
#Question 2:  Do any of your simulated datasets support the hypothesis of a decline in diversification rate over time?  If so, which ones?  Take a screenshot or send me a jpg of your gamma statistic histogram.
